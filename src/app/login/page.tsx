...
import LoginImage from "@/assets/login-night.png";
          ...
          <div className="container mx-auto grid grid-cols-1 items-center">
            ...
            <div className="flex justify-center">
              <div className={cn("w-full max-w-md px-6 py-8 text-[#303030]")}>
                <div className="text-center">
                  <h2 className={cn("mb-2 text-3xl font-bold")}>
                    Login to Account
                  </h2>
                ...
                <form onSubmit={handleLogin} className="">
                  <div className="mb-4">
                    ...
                    <Input
                      className={cn(
                        "h-auto w-full rounded-2xl border border-[#3C3C3C] px-3 py-2 placeholder:text-[#3C3C3C] focus:outline-none 2xl:rounded-[20px] 2xl:px-4 2xl:py-3",
                      )}
                      id="email"
                      name="email"
                      placeholder="Enter email"
                  ...
                  <div className="mb-6">
                    ...
                    <div className="relative flex items-center">
                      <Input
                        className={cn(
                          "h-auto w-full rounded-2xl border border-[#3C3C3C] px-3 py-2 pr-10 placeholder:text-[#3C3C3C] focus:outline-none 2xl:rounded-[20px] 2xl:px-4 2xl:py-3",
                        )}
                        id="password"
                        name="password"
                        placeholder="Enter password"
                  ...
                  <Button
                    className={cn(
                      "h-auto w-full rounded-[20px] bg-[#616FF5] px-3 py-3 font-bold text-white transition duration-300 hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none",
                    )}
                    type="submit"
                    disabled={isLoading}
                  >
