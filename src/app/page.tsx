export default function Home() {
  return (
    <div className="h-fit w-full space-y-8 p-8">
      <div className="flex flex-row gap-5">
        <div className="flex flex-col gap-5">
          <div className="flex flex-row space-x-8">
            <div className="bg-primary-foreground dark:bg-accent flex h-32 w-64 flex-col p-2">
          ...
          <div className="bg-primary-foreground dark:bg-accent h-52 w-full p-2">
            <h2 className="text-2xl font-semibold">Sale Performance</h2>
          </div>
        </div>
        <div className="bg-primary-foreground dark:bg-accent flex h-full w-full flex-col items-center justify-center">
      ...
      <div className="bg-primary-foreground dark:bg-accent h-56 w-full p-2">
